...
export default tseslint.config(
  { ignores: ["dist", "node_modules", "coverage", "tests/bench/results*/**"] },
  ...
  },
  {
    ...
    files: ["dsh/client.js"],
    languageOptions: {
      globals: { window: "readonly", document: "readonly", console: "readonly", fetch: "readonly", URL: "readonly", setTimeout: "readonly" },
    },
  },
  {
