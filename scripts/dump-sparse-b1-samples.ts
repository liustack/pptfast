...
const NOTE = "试点客户 90 天 · 全部 217 张工单"
...
const SAMPLES: { theme: string; layout: string; slides: Slide[]; index: number }[] = [
  ...
  { theme: "stage", layout: "stat-hero", slides: [chapter("席位净流失降幅"), statHero("43%", "试点客户 · 90 天")], index: 1 },
  { theme: "stage", layout: "pull-quote", slides: [pullQuote(QUOTE, ATTR)], index: 0 },
  {
    theme: "lecture",
    layout: "statement",
    slides: [{ ...statement(VERSE), subheading: "工作区订阅开课第一句" } as Slide],
    index: 0,
  },
  { theme: "lecture", layout: "stat-hero", slides: [chapter("九十天试点，写在黑板上的那个数："), statHero("43%", "订阅续约率同比回升")], index: 1 },
  { theme: "lecture", layout: "one-evidence", slides: [oneEvidence(CLAIM, NOTE)], index: 0 },
  { theme: "swiss", layout: "stat-hero", slides: [statHero("43%", "订阅续约率同比回升"), { type: "content", heading: "x", components: [] } as Slide, { type: "content", heading: "y", components: [] } as Slide], index: 0 },
  ...
  { theme: "memo", layout: "stat-hero", slides: [statHero("43%", "席位净流失时长，试点客户 90 天")], index: 0 },
  { theme: "memo", layout: "statement", slides: [statement("设备不会突然坏，只是没人听它说话。")], index: 0 },
  { theme: "playbill", layout: "statement", slides: [chapter("工作区订阅 · 开演"), statement(VERSE_LISTEN)], index: 1 },
  { theme: "playbill", layout: "stat-hero", slides: [statHero("-43%", "席位净流失 · 试点 90 天")], index: 0 },
  { theme: "playbill", layout: "mono-bleed", slides: [monoBleed("凌晨两点的会议，以后交给工作区")], index: 0 },
  ...
  { theme: "museum", layout: "stat-hero", slides: [statHero("43%", "订阅续约率同比回升 · 90 天")], index: 0 },
  { theme: "luxe", layout: "pull-quote", slides: [pullQuote(QUOTE, ATTR)], index: 0 },
  { theme: "luxe", layout: "stat-hero", slides: [statHero("43%", "席位净流失 · 九十日")], index: 0 },
  ...
  { theme: "ink", layout: "stat-hero", slides: [statHero("43%", "订阅续约率同比回升 · 九十日为期")], index: 0 },
