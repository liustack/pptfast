...
const CONSULTING_VERSE = "预测性维护值得**全线推开**，而且应该从今天开始。"
...
const SAMPLES: { theme: string; layout: string; slides: Slide[]; index: number; extra?: Partial<PptxIR> }[] = [
  ...
  { theme: "consulting", layout: "stat-hero", slides: [statHero("43%", "非计划停机时长下降", "试点产线 90 天 · 2026 Q2 运行数据")], index: 0 },
  { theme: "consulting", layout: "one-evidence", slides: [oneEvidence(CLAIM, NOTE)], index: 0 },
  {
    ...
    index: 0,
    extra: { meta: { organization: "岭原智能", date: "2026-05-20" } },
  },
  {
    theme: "insight",
    layout: "stat-hero",
    slides: [statHero("-43%", "非计划停机 · 环比", "PILOT LINE · 90D WINDOW")],
    index: 0,
    extra: { meta: { organization: "岭原智能", date: "2026-05-20" } },
  },
  { theme: "insight", layout: "pull-quote", slides: [pullQuote(QUOTE, ATTR)], index: 0 },
  { theme: "tech", layout: "stat-hero", slides: [statHero("43%", "非计划停机时长下降", "试点产线 · 90 天窗口")], index: 0 },
  ...
  { theme: "heritage", layout: "stat-hero", slides: [statHero("43%", "非计划停机时长下降 · 九十日")], index: 0 },
  {
    theme: "vermilion",
    layout: "statement",
    slides: [statement(VERSE)],
    index: 0,
    extra: { meta: { organization: "岭原智能", date: "2026-08" } },
  },
  { theme: "vermilion", layout: "stat-hero", slides: [statHero("43%", "非计划停机时长下降 · 试点产线九十日")], index: 0 },
  ...
  { theme: "journal", layout: "stat-hero", slides: [statHero("43%", "非计划停机时长下降 · 九十日为证")], index: 0 },
  ...
  { theme: "campaign", layout: "statement", slides: [statement(VERSE_LISTEN)], index: 0 },
  {
    theme: "campaign",
    layout: "stat-hero",
    slides: [chapter("九十天，一个数"), statHero("43%", "非计划停机时长下降")],
    index: 1,
  },
  { theme: "campaign", layout: "one-evidence", slides: [oneEvidence(CLAIM, "217 张工单全量统计 · 2026 Q2")], index: 0 },
  { theme: "arena", layout: "stat-hero", slides: [statHero("43%", "非计划停机 · 降幅")], index: 0 },
  ...
  { theme: "terra", layout: "stat-hero", slides: [statHero("43%", "非计划停机时长下降", "试点产线 · 90 天 · 现场实测")], index: 0 },
  ...
  },
  {
    theme: "academic",
    layout: "stat-hero",
    slides: [statHero("43%", "非计划停机时长下降", "试点产线 90 天窗口")],
    index: 0,
  },
  {
    theme: "academic",
