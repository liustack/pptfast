 ...
 *      （`fontWeight=700`）。
 *   2. 底线板上约 y627，落在第五带 y620-664。上收到 y610（tone-adaptive
 *      底部分隔线同款：版式的线停在第五带之上）。落款字仍在线下面。
 *   3. 左下落款板上在 x56。enterprise-motif 在 (60,626) 有一枚 16×16
 *      accent 方块（tech 会抽到这家 motif），字压上去 1.42:1。左缘收到
 *      x96，躲开那一枚方块。
 *   4. 右下落款板上顶到右缘 56px，压 logo 盒。右缘收到 x1108。
 *   5. 日期贴片不在本文件。无 `meta.date` 时 motif 整片不画，版式不补空块。
 */
