...
describe("ImageLeadSplitContent geometry", () => {
  ...
  // Controller-probed defect (content-layout expansion wave, follow-up
  ...
  describe("starved (no scalable lead component): the text column reclaims the freed width", () => {
    ...
    // existing layout's own (x, width) class — `narrow-column`/
...
// Content-layout expansion wave, task T3 — coverage gap T2's review
// found: this layout's text column was never stress-tested against
