...
// Vertical-gravity re-pin (2026-08-20): only `MAGAZINE_EXPECTED_BARE`
// moves, and only in two tokens — its lone block's `data-audit-box` y and
// the `translate` that renders it, 372.88 -> 230, flush with the content
// rect's own top instead of 38% of the leftover below it. `MAGAZINE_EXPECTED`
// is untouched: its three blocks already reach 640 with nothing left over,
// so neither the gap ceiling nor the leftover rule has anything to spend.
