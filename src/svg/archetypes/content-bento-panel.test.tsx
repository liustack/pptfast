...
// `contrastRatio("#DC2626", "#0A101C")` (this card's own surface) = 3.94:1,
// under the 16px arrow's 4.5:1 body floor (verified, not assumed —
// `pnpm exec tsx`); `accessibleInk` falls back to `readableOn("#0A101C")`'s
// #FFFFFF (19.03:1). A real, reproducible defect this capture happened to
