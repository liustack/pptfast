...
describe("ToneAdaptiveContent", () => {
  describe("custom tokens 下输出锁定（迁移前已与旧 CustomContent 逐字节核对一致）", () => {
    it("无背景图分支（多 component + subheading + footnote + kicker）", () => {
      ...
      expect(next).toContain("章节 01 · 第一部分：产品概览")
    })
