 ...
 * | museum | museum-motif *(singleton)* | 2026-08-21: museum's specimen-label + pin-dot vocabulary is its own new technique family — a small exhibition plaque and four corner pins, not luxe's full gilt frame, not heritage's masthead rules, not insight's ticker. Pairing any of those in would read as a mismatched skin rather than a variation. Stays a candidate set of 1 (same rationale pattern as campaign/ink/pulse/terra/ember/vermilion/crayon/arena) |
 *
